...
export default function RoleInfoHeader({role,topicsToFocus,
             experience,questions,description,lastUpdatedAt}) {
  return (
    <div className='bg-white relative'>
        <div className='container mx-auto px-10 md:px-0'>
            <div className='h-[200px] flex flex-col justify-center realtive z-10'>
                ...
                <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0'>
                    ...
                    <div className='w-16 h-16 bg-cyan-300 blur-[45px] animate-blob1'>
